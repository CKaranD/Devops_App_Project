...
sudo docker push 180844954664.dkr.ecr.ap-southeast-1.amazonaws.com/zus-phase2-lambda-conversation-bot-vecdb:latest

#staging
sudo docker tag lambda_conversation_bot_vecdb:latest 180844954664.dkr.ecr.ap-southeast-1.amazonaws.com/staging-zus-phase2-lambda-conversation-bot-vecdb:latest

sudo docker push 180844954664.dkr.ecr.ap-southeast-1.amazonaws.com/staging-zus-phase2-lambda-conversation-bot-vecdb:latest
